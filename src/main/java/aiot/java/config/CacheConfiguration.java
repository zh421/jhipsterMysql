...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, aiot.java.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, aiot.java.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, aiot.java.domain.DeviceCode.class.getName());
            createCache(cm, aiot.java.domain.EventInter.class.getName());
            ...
            createCache(cm, aiot.java.domain.NoticeInfo.class.getName());
