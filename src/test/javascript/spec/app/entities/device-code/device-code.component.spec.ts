...
import { DeviceCodeComponent } from 'app/entities/device-code/device-code.component';
...
describe('Component Tests', () => {
  describe('DeviceCode Management Component', () => {
    let comp: DeviceCodeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DeviceCodeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.deviceCodes && comp.deviceCodes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
