...
import { NoticeInfoComponent } from 'app/entities/notice-info/notice-info.component';
...
describe('Component Tests', () => {
  describe('NoticeInfo Management Component', () => {
    let comp: NoticeInfoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(NoticeInfoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.noticeInfos && comp.noticeInfos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
