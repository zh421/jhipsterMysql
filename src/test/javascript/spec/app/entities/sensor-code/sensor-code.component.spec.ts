...
import { SensorCodeComponent } from 'app/entities/sensor-code/sensor-code.component';
...
describe('Component Tests', () => {
  describe('SensorCode Management Component', () => {
    let comp: SensorCodeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [SensorCodeComponent],
        providers: [
          {
        ...
        .overrideTemplate(SensorCodeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.sensorCodes && comp.sensorCodes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
